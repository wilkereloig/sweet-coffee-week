...
const AI_PESQUISA = {
  data: '14/06/2026',
  nRespostas: 1548,
  avaliacaoGeral: 'Com a base agora quase triplicada (1548 respostas, contra 602 na parcial de 08/06), o sentimento geral se mantém fortemente positivo e até se consolida: a satisfação com a Sweet & Coffee Week Lovers é altíssima e o evento já é tratado como ritual afetivo de cidade — palavras como "maravilhoso", "perfeito", "amei" e "experiência" dominam as respostas longas. Na pergunta sobre o que melhorar, "nada" segue sendo a resposta isolada mais frequente (111 ocorrências literais) e, somando todas as variações de não-crítica ("tudo perfeito", "nada a reclamar/declarar", "gostei de tudo", "sem comentários"), cerca de 291 pessoas (1 em cada 5 que responderam o campo) declararam não ter o que apontar. O que mais encanta é a combinação de descoberta + criatividade gastronômica: "variedade/diversidade" e "conhecer novos lugares" aparecem em ~329 respostas de "gostou", a dupla "criatividade/tema" em ~387, e menções diretas a combo/salgado/doce/sabor em ~577. A diferença marcante desta base maior é que, ao lado do encantamento, emergiu um eixo crítico mais claro e recorrente do que na amostra pequena: o desejo por MAIS TEMPO de evento. Críticas a tempo/duração/horário aparecem em 232 respostas de "melhorar" (o maior bloco temático), com 117 pedindo explicitamente mais dias e 16 reclamando da colisão com Copa, São João e Dia dos Namorados de junho. Logo atrás vêm a sensação de tema solto/abrangente (~130 menções a "tema", sendo ~33 reclamações explícitas de tema vago/genérico/diluído) e a questão de preço (~128 menções), agora muitas vezes atrelada a uma crítica qualitativa nova: o combo de R$38,90 só "vale" quando há criatividade — coxinha e refrigerante comuns passaram a ser citados como decepção que não justifica o valor.',
  notaPercebida: 'A satisfação percebida é muito alta — estimável em torno de 9/10 — sustentada pelo enorme volume de respostas sem qualquer crítica (~291) e pela densidade de superlativos espontâneos. A insatisfação, quando existe, é pontual (combo/loja específicos) e construtiva, raramente atingindo o conceito do festival em si.',
  pontosFortes: [
    'Descoberta de lugares novos é o maior motor afetivo: ~329 respostas citam variedade/diversidade e "conhecer novos lugares", com o público tratando a semana como um roteiro/maratona pela cidade para visitar docerias e cafeterias que nunca frequentaria — vários relatos de "conheci por causa do Sweet".',
    'Criatividade e o próprio conceito de tema encantam: ~387 menções a criatividade/tema/conceito; quando uma casa mergulha de fato no tema (decoração, narrativa do combo, harmonização), o cliente sente uma imersão memorável — citações recorrentes elogiam combos que "contam uma história".',
    'Qualidade e formato do combo (doce + salgado + bebida por preço único) é o coração da aprovação: ~577 respostas mencionam combo/salgado/doce/sabor positivamente, com destaque para porções generosas, harmonização e o prazer de provar itens fora do cardápio habitual.',
    'Acessibilidade do preço único ainda é vista como virtude por muitos: ~74 respostas de "gostou" elogiam o valor/preço acessível e o "pagar um valor só em vários lugares", permitindo "maratonar" os participantes — um contraponto importante às críticas de preço.',
    'Experiência social e afetiva: ~47 respostas ligam o evento a reunir amigos e família, "vibe", animação que toma conta da cidade e confraternização — o Sweet é consumido como programa coletivo, não só como refeição.',
    'Atendimento e dedicação de casas-referência geram fidelidade: ~63 menções positivas a atendimento/equipe/rapidez, com nomes recorrentes como O Maestro (13), Bolomania (12), Jolie (6) e Delicato (5) citados espontaneamente como exemplos de excelência e capricho na ambientação.',
    'A camada de gamificação e curadoria (mapa, carimbos/colecionáveis, tour de divulgação, QR Code na mesa) é elogiada espontaneamente (~13 menções) como algo que torna a jornada divertida e ajuda o público indeciso a montar a rota.',
  ],
  pontosMelhorar: [
    'Duração e calendário (maior bloco de críticas, 232 menções): o pedido nº1 é mais tempo de evento — 117 pessoas querem explicitamente mais dias (sugestões frequentes de 15 dias, 2 semanas ou até 1 mês), argumentando que "10 dias é pouco" para quem trabalha o dia todo; agravado pelo choque de junho com Copa, São João e Dia dos Namorados (16 menções diretas) que "roubou" dias e fez casas encerrarem mais cedo.',
    'Tema percebido como solto/abrangente (~130 menções a "tema", ~33 reclamações explícitas): a edição comemorativa de aniversário deixou o tema "vago", "difuso", "sem coesão", com cada casa fazendo subtemas que "não conversam entre si" — o que, segundo o público, atrapalha a comparação na votação e tira a "magia" de ver todos interpretando um mesmo desafio criativo.',
    'Preço x entrega (~128 menções): a crítica de preço evoluiu — não é só "caro", é a percepção de que R$38,90 só compensa com inovação; combos com itens banais (coxinha comum, refrigerante/soda de xarope) são citados como "não valeu", e há pedido de mais padronização de tamanho/peso entre lojas para evitar frustração.',
    'Bebida do combo (~76 menções): ponto novo e recorrente — sodas/xaropes artificiais e refrigerantes desagradam parte do público, que pede opções (trocar por café, água ou suco natural) e reclama de drinks "fracos" ou excessivamente doces.',
    'Atendimento, filas e gestão de demanda (~68 menções): demora para receber o combo, filas longas, lojas lotadas e combos esgotando no meio do horário de funcionamento; pedido de melhor preparação para a demanda e de informar até que horas o combo está disponível.',
    'Imersão/decoração desigual entre participantes (~62 menções): contraste forte entre casas que "abraçaram" o tema e as que "não entraram no clima" — funcionários que nem sabiam do festival, ambientes sem caracterização — pedindo curadoria/fiscalização mínima de padrão para o selo do evento.',
    'Fidelidade à divulgação e cobertura geográfica: ~48 menções a porção/apresentação diferente da foto do Instagram ("propaganda enganosa", combo menor que o anunciado) e ~43 menções pedindo mais lojas fora do eixo concentrado, com a Zona Norte de Natal citada nominalmente como mal atendida.',
  ],
  temas: [
    'Audiovisual e cultura pop (categoria mais pedida, ~275 menções): filmes, séries, novelas, animes, doramas, desenhos e franquias — citações concretas frequentes a Disney, Harry Potter, Star Wars, Stranger Things, Studio Ghibli, terror e clássicos do cinema; ideia recorrente de cada casa recriar pratos icônicos de obras famosas.',
    'Brasilidade e regionalismo (~210 menções): comidas típicas dos estados, "sabores potiguar/do RN", Nordeste, Seridó, folclore e cultura local — forte desejo de valorizar ingredientes e cidades brasileiras; vários sugerem cada doceria homenagear um estado ou cidade.',
    'Música (~156 menções): gêneros e artistas (pop, rock, K-pop/BTS, forró, samba, MPB, sertanejo, funk, jazz, divas pop) com cada casa assumindo um estilo ou cantor — impulsionado pelo sucesso do combo temático de BTS desta edição.',
    'Países e viagem pelo mundo (~109 menções): culinária de outros países (França, Itália, Coreia, Japão, árabe/mediterrânea), com o lamento recorrente de que, sendo ano de Copa, o tema "Copa do Mundo / cada loja um país" foi uma oportunidade perdida.',
    'Nostalgia, décadas e épocas históricas (~99 menções): anos 80/90/2000, "sabores da infância", sessão da tarde, túnel do tempo e épocas históricas (Idade Média, Era Vitoriana, Grécia/Egito) — resgate afetivo do passado.',
