...
import {
  ...
  slugPrevisto, resumoParticipante, montarRecado, linkWhatsApp,
...
// recarregadas (a senha não fica guardada em lugar nenhum). Serve as duas
// entradas que criam acesso: cadastro manual (aqui) e, no futuro, "criar
// acesso" a partir de uma candidatura aprovada em Respostas.
function Credenciais({ nomeMarca, telefone, login, senha }) {
